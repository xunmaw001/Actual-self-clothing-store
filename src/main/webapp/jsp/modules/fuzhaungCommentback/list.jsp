...
<!--/Pre Loader -->
    ...
    <script>
        ...
        function getDataList() {
            http("fuzhaungCommentback/page", "GET", {
                page: pageIndex,
                limit: pageSize,
                sort: sortColumn,
                order: sortOrder,
                fuzhaungCommentbackDelete: 1,
                //本表的
            //级联表的
        ...
        function setDataRow(item, number) {
            ...
            //评价内容
            var fuzhaungCommentbackTextCell = document.createElement('td');
            fuzhaungCommentbackTextCell.innerHTML = item.fuzhaungCommentbackText;
            row.appendChild(fuzhaungCommentbackTextCell);
        ...
        function remove(id) {
            ...
            if (mymessage == true) {
                ...
                httpJson("fuzhaungCommentback/delete", "POST", paramArray, (res) => {
                    if(res.code == 0){
                        getDataList();
                        alert('删除成功');
                    }
        ...
        //添加
        function add() {
            window.sessionStorage.setItem("addfuzhaungCommentback", "addfuzhaungCommentback");
            window.location.href = "add-or-update.jsp"
        }
        ...
        function exportExcel() {
            excel = new ExcelGen({
                "src_id": "tableId",
                "show_header": true,
                "file_name": 'fuzhaungCommentback.xlsx'
            });
            excel.generate();
        }
