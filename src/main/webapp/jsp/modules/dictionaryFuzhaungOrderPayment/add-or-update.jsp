...
<script>
    ...
    var tableName = "dictionaryFuzhaungOrderPayment";
    ...
    function submit() {
        if (validform() == true && compare() == true) {
            ...
            data["dicCode"] = "fuzhaung_order_payment_types";
            data["dicName"] = "订单支付类型";
    ...
    function getDetails() {
        ...
        if (adddictionary != null && adddictionary != "" && adddictionary != "null") {
            ...
            $(validform());
            $('#submitBtn').text('新增');
            httpJson("dictionary/maxCodeIndex" , "POST", {"dicCode":"fuzhaung_order_payment_types"}, (res) => {
                if(res.code == 0){
