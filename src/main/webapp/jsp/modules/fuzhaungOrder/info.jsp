                            ...
                            <!-- 本表所有字段 -->
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input style="width: 450px" id="fuzhaungOrderUuidNumber" name="fuzhaungOrderUuidNumber" class="form-control"
                                               v-model="ruleForm.fuzhaungOrderUuidNumber" readonly>
                                    </div>

                                <input id="addressId" name="addressId" v-model="ruleForm.addressId" readonly type="hidden">
                                <input id="fuzhaungId" name="fuzhaungId" v-model="ruleForm.fuzhaungId" readonly type="hidden">
                                <input id="yonghuId" name="yonghuId" v-model="ruleForm.yonghuId" readonly type="hidden">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input style="width: 450px" id="fuzhaungOrderTruePrice" name="fuzhaungOrderTruePrice" class="form-control"
                                               v-model="ruleForm.fuzhaungOrderTruePrice" readonly>
                                    </div>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input style="width: 450px" id="fuzhaungOrderCourierName" name="fuzhaungOrderCourierName" class="form-control"
                                               v-model="ruleForm.fuzhaungOrderCourierName" readonly>
                                    </div>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input style="width: 450px" id="fuzhaungOrderCourierNumber" name="fuzhaungOrderCourierNumber" class="form-control"
                                               v-model="ruleForm.fuzhaungOrderCourierNumber" readonly>
                                    </div>


                                <div class="form-group col-md-6">
                                    <label>订单类型</label>
                                    <input style="width: 450px" id="fuzhaungOrderValue" name="fuzhaungOrderValue" class="form-control"
                                           v-model="ruleForm.fuzhaungOrderValue" readonly>
                                </div>

                                <div class="form-group col-md-6">
                                    <label>支付类型</label>
                                    <input style="width: 450px" id="fuzhaungOrderPaymentValue" name="fuzhaungOrderPaymentValue" class="form-control"
                                           v-model="ruleForm.fuzhaungOrderPaymentValue" readonly>
                                </div>
    ...
    var vm = new Vue({
        ...
        beforeCreate: function () {
            ...
            if (id != null && id != "" && id != "null") {
                $.ajax({
                    type: "GET",
                    url: baseUrl + "fuzhaungOrder/info/" + id,
