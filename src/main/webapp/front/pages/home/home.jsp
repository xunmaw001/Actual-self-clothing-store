    ...
    <div class="ng-container ng-fault">
            ...
            <div class="ng-inmod-ini">
                    <div class="ng-fault ng-container">
                        <div class="ng-inmod-the ng-container">
                            ...
                            <span class="ng-inmod-the-en" aos="fade-up">NEWS</span>
                        </div>
                        <span class="ng-inmod-thebor" aos="fade-up"></span>
                    </div>
                <div class="ng-incontlst ng-fault ng-container ng-ai-drive1_map" aos="fade-up">
                    <div>
                        <div v-for="(item,index) in newsList" v-bind:key="index" class="col-md-3 col-sm-3 col-xs-6 w3gallery-grids">
                            <div class="imghvr-hinge-right figure" style="width: 100%" @click="jumpCheck('../news/detail.jsp?id='+item.id , item.aaaaaaaaaa == null?'':item.aaaaaaaaaa , item.shangxiaTypes == null?'':item.shangxiaTypes)">
                                <img :src="item.newsPhoto?item.newsPhoto.split(',')[0]:''" style="height: 350px;width:100%;"/>
                                <div class="agile-figcaption">
                                    <h4>{{item.newsName}}</h4>
                                    <h4 v-if="item.newsNewMoney">
                                        {{item.newsNewMoney}} RMB
                                    </h4>
                                    <h4 v-else>
                                        {{item.newsValue}}
                                    </h4>
        ...
        <div class="ng-inmod ng-fault ng-paddor ng-bg-assist">
            <div class="ng-inmod-ini">
                ...
                <div class="ng-incontlst ng-fault ng-container ng-ai-drive1_map" aos="fade-up">
                    <div>
                        <div v-for="(item,index) in fuzhaungList" v-bind:key="index" class="col-md-3 col-sm-3 col-xs-6 w3gallery-grids">
                            <div class="imghvr-hinge-right figure" style="width: 100%" @click="jumpCheck('../fuzhaung/detail.jsp?id='+item.id , item.aaaaaaaaaa == null?'':item.aaaaaaaaaa , item.shangxiaTypes == null?'':item.shangxiaTypes)">
                                <img :src="item.fuzhaungPhoto?item.fuzhaungPhoto.split(',')[0]:''" style="height: 350px;width:100%;"/>
                                <div class="agile-figcaption">
                                    <h4>{{item.fuzhaungName}}</h4>
                                    <h4 v-if="item.fuzhaungNewMoney">
                                        {{item.fuzhaungNewMoney}} RMB
                                    </h4>
                                    <h4 v-else>
                                        {{item.fuzhaungValue}}
                                    </h4>
...
<script>
    ...
    layui.use(['layer', 'form', 'element', 'carousel', 'http', 'jquery'], function () {
        ...
        http.request(`fuzhaung/list`, 'get', {
            ...
            vue.fuzhaungList = res.data.list;
        });
    });
</script>
