    ...
    public R info(@PathVariable("id") Long id, HttpServletRequest request){
        ...
        if(cart !=null){
            ...
            BeanUtils.copyProperties( cart , view );//把实体数据重构到view中
                ...
                //级联表
                FuzhaungEntity fuzhaung = fuzhaungService.selectById(cart.getFuzhaungId());
                if(fuzhaung != null){
    ...
    */
    ...
    public R save(@RequestBody CartEntity cart, HttpServletRequest request){
        ...
        Wrapper<CartEntity> queryWrapper = new EntityWrapper<CartEntity>()
            ...
            .eq("fuzhaung_id", cart.getFuzhaungId())
...
//                            cartEntity.setFuzhaungId(Integer.valueOf(data.get(0)));   //服装 要改的
