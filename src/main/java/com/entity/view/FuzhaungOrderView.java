...
public class FuzhaungOrderView extends FuzhaungOrderEntity implements Serializable {
    private static final long serialVersionUID = 1L;

		/**
		* 订单类型的值
		*/
		private String fuzhaungOrderValue;
		/**
		* 支付类型的值
		*/
		private String fuzhaungOrderPaymentValue;
	...
	public FuzhaungOrderView() {

	}

	public FuzhaungOrderView(FuzhaungOrderEntity fuzhaungOrderEntity) {
		try {
			BeanUtils.copyProperties(this, fuzhaungOrderEntity);
			...
			* 获取： 订单类型的值
			*/
			public String getFuzhaungOrderValue() {
				return fuzhaungOrderValue;
			}
			/**
			* 设置： 订单类型的值
			*/
			public void setFuzhaungOrderValue(String fuzhaungOrderValue) {
				this.fuzhaungOrderValue = fuzhaungOrderValue;
			}
			/**
			* 获取： 支付类型的值
			*/
			public String getFuzhaungOrderPaymentValue() {
				return fuzhaungOrderPaymentValue;
			}
			/**
			* 设置： 支付类型的值
			*/
			public void setFuzhaungOrderPaymentValue(String fuzhaungOrderPaymentValue) {
				this.fuzhaungOrderPaymentValue = fuzhaungOrderPaymentValue;
			}
