...
public class FuzhaungCommentbackView extends FuzhaungCommentbackEntity implements Serializable {
	...
	public FuzhaungCommentbackView() {

	}

	public FuzhaungCommentbackView(FuzhaungCommentbackEntity fuzhaungCommentbackEntity) {
		try {
			BeanUtils.copyProperties(this, fuzhaungCommentbackEntity);
